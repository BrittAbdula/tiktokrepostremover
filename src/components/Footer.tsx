      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="mailto:support@tiktokrepostremover.com" className="hover:text-white transition-colors">Contact Support</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="https://github.com/your-repo" className="hover:text-white transition-colors flex items-center">
                <img 
              ...
              <li><a href="https://twitter.com/your-handle" className="hover:text-white transition-colors flex items-center">
                <img 
